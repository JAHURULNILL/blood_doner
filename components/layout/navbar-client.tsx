...
import { X, Droplets, Menu, ShieldCheck, ArrowUpRight, HeartHandshake, LayoutDashboard, LogOut, UserRound } from "lucide-react";
...
export function NavbarClient({ user }: { user: UserRecord | null }) {
